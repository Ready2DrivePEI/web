          ...
          <div className="rounded-3xl border border-blue-100 bg-[#f4f8fe] p-3 sm:p-5 md:p-6">
            ...
            <div className="grid gap-4 sm:gap-5 lg:grid-cols-[0.7fr_1.3fr]">
              ...
              <RevealOnScroll className="hidden h-full sm:block">
                <div className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_12px_30px_rgba(15,23,42,0.08)]">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-500">
                    Contact
                  </p>
                  <h2 className="mt-4 font-semibold text-[2.1rem] leading-tight text-slate-950 tracking-tight">
              ...
              <div className="sm:hidden">
                ...
                <h2 className="mt-2 font-semibold text-[1.375rem] leading-tight text-slate-950 tracking-tight">
                  Tell us your current stage. We'll guide your next steps.
                </h2>
              ...
              <RevealOnScroll delayMs={120} className="h-full">
                <div className="h-full rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_14px_34px_rgba(15,23,42,0.1)] sm:p-7">
